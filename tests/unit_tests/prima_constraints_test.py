...
from src.utilities.prima_util import KAct, make_kactivation_obj
...
class TestPrimaConstraints:
    ...
    def test_toy_example_in_paper(self) -> None:
        ...
        constraint_object = make_kactivation_obj(input_octahedron_constraints)

        input_octahedron_constraints = [np.array([2.0, 1.0]), np.array([1.2, -1.0])]
        other_constraint_object = make_kactivation_obj(input_octahedron_constraints)
